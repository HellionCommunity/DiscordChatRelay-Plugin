...
namespace HESDiscordChatBot
{
    ...
    public class MyConfig
    {
        ...
        public bool SaveConfiguration()
        {
            ...
            {
                Console.WriteLine("HESDiscordChatBot:  Configuration Save Failed! (SaveConfiguration):" + ex.ToString());
            }
            return false;
        }
        ...
        public bool LoadConfiguration()
        {
            ...
            {
                Console.WriteLine("HESDiscordChatBot:  Config.xml does not exist, creating one from defaults.");
                SaveConfiguration();              
                return true;
            }
            ...
            try
            {
                ...
                using (XmlReader reader = new XmlTextReader(fs))
                {
                    ...
                    {
                        Console.WriteLine("HESDiscordChatBot:  Could not deserialize HES's Configuration File! Load Failed!");
                        return false;
                    }
            ...
            {
                Console.WriteLine("HESDiscordChatBot:  Configuration Load Failed! (LoadConfiguration):" + ex.ToString());
            }
            return false;
        }
        ...
        private void WriteComments()
        {
            ...
            {
                Console.WriteLine("HESDiscordChatBot:  Configuration Save Failed! (WriteComments)" + ex.ToString());
            }
        }
    }
}